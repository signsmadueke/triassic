    ...
    <div class="container pl-30 pr-30">
        <div class="row align-items-start pb-75 pt-100 cform">
            <div class="col-lg-6 col-md-12 col-sm-12 mb-md-50 mb-sm-50">
                ...
                <span class="text-sm-red mb-10">Contact us</span>
                ...
                <div class="row align-items-center support">
                    ...
                    <div class="col-9 row pl-0 ml-0">
                        <div class="col-12">
                            <a href="mailto:info@triassictechnologies.com">info@triassictechnologies.com</a>
                        </div>
                        <div class="col-12">
                            <a href="tel:+2348067852344">+234 806 785 2344</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-md-12 col-sm-12">
                <form action="index.php" class="contact_form form-vertical dark text-left" id="contact-center-form-form">
                    <div class="form-group mb-20">
                        <input type="text" class="form-control spr-form-required" placeholder="Name" name="name" size="10">
                    </div>
                    <div class="form-group mb-20">
